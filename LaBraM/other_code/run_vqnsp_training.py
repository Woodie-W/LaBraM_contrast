...
def get_args():
    ...
    parser.add_argument('--clip_grad', type=float, default=1.0, metavar='NORM',
                        help='Clip gradient norm (default: None, no clipping),set 1.0')
    ...
    parser.add_argument('--lr', type=float, default=1e-6, metavar='LR',
                        help='learning rate (default: 5e-5), use 1e-5')
    ...
    parser.add_argument('--min_lr', type=float, default=1e-7, metavar='LR',
                        help='lower lr bound for cyclic schedulers that hit 0 (1e-5),use 1e-6')
...
def get_model(args, **kwargs):
    model = create_model(args.model, pretrained=False, as_tokenzer=False, n_code=args.codebook_n_emd,
                         code_dim=args.codebook_emd_dim, EEG_size=args.input_size, decay=args.ema_decay,
...
def main(args):
    ...
    # # 在保证数据集的通道数量和通道顺序一致的情况下,可以将不同数据集的路径放在一个list中,或许需要更改数据格式?
    # # get dataset
    ...
    #         ['./pretrain_set/EEG/LEMON/61chs','./pretrain_set/EEG/SXMU_1_PROCESSED/HC/61chs', ],
    ...
    #         ['./pretrain_set/EEG/SXMU_1_PROCESSED/MDD/72chs','./pretrain_set/EEG/SXMU_1_PROCESSED/HC/72chs', ],
    #         # ['./pretrain_set/EEG/SXMU_1_PROCESSED/HC/72chs', ],
    #         ['./pretrain_set/EEG/TUHEEG_PROCESSED/tuh_eeg_abnormal/train/abnormal/19chs','./pretrain_set/EEG/TUHEEG_PROCESSED/tuh_eeg_abnormal/train/normal/19chs',
    #         './pretrain_set/EEG/TUHEEG_PROCESSED/tuh_eeg_events/eval/19chs','./pretrain_set/EEG/TUHEEG_PROCESSED/tuh_eeg_events/train/19chs',
    #         './pretrain_set/EEG/TUHEEG_PROCESSED/tuh_eeg_epilepsy/00_epilepsy/19chs','./pretrain_set/EEG/TUHEEG_PROCESSED/tuh_eeg_epilepsy/01_no_epilepsy/19chs'
    ...
    #         # ['./pretrain_set/EEG/TUHEEG_PROCESSED/tuh_eeg_slowing/19chs', ],
    #         ['./pretrain_set/EEG/TUHEEG_PROCESSED/tuh_eeg_abnormal/train/abnormal/20chs','./pretrain_set/EEG/TUHEEG_PROCESSED/tuh_eeg_events/eval/20chs',
    #         './pretrain_set/EEG/TUHEEG_PROCESSED/tuh_eeg_epilepsy/00_epilepsy/20chs',
    #         './pretrain_set/EEG/TUHEEG_PROCESSED/tuh_eeg_epilepsy/01_no_epilepsy/20chs','./pretrain_set/EEG/TUHEEG_PROCESSED/tuh_eeg_slowing/20chs', ],
    ...
    datasets_train = [
            ...
            ['./pretrain_set/EEG/TUHEEG_PROCESSED/tuh_eeg_events/eval/20chs', ], #(数据量<bs，iteration=0)
            ['./pretrain_set/EEG/TUHEEG_PROCESSED/tuh_eeg_events/train/19chs', ],
            ['./pretrain_set/EEG/TUHEEG_PROCESSED/tuh_eeg_epilepsy/00_epilepsy/20chs', ],
            ['./pretrain_set/EEG/TUHEEG_PROCESSED/tuh_eeg_epilepsy/01_no_epilepsy/20chs', ],
            ['./pretrain_set/EEG/TUHEEG_PROCESSED/tuh_eeg_slowing/20chs', ],
    ...
    datasets_val = [
            ...
            # ['./fine_pool/EEG/TUHEEG_PROCESSED/tuh_eeg_abnormal/eval/abnormal/19chs','./fine_pool/EEG/TUHEEG_PROCESSED/tuh_eeg_abnormal/eval/normal/19chs', ],
            # ['./fine_pool/EEG/TUHEEG_PROCESSED/tuh_eeg_abnormal/eval/normal/19chs', ],
            ['./fine_pool/EEG/SXMU_2_PROCESSED/HC/59chs','./fine_pool/EEG/SXMU_2_PROCESSED/MDD/59chs', ],
            # ['./fine_pool/EEG/SXMU_2_PROCESSED/MDD/59chs', ],
    ]
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if data_loader_val_list is not None:
            test_stats = evaluate(data_loader_val_list, model, device, log_writer, epoch,
                                  ch_names_list=val_ch_names_list, args=args,datasets_val=datasets_val)
            print(
