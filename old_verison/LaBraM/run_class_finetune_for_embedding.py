...
def prepare_data(seed, split=True,json_folder=None):
    ...
    hc = {
        "HC": [
            os.path.join(
                "/data/sxk/labram2_resting_fine_pool/resting_unknown/SXMU_2_PROCESSED/HC/59chs",
                file,
            )
    ...
    mdd = {
        "MDD": [
            os.path.join(
                "/data/sxk/labram2_resting_fine_pool/resting_unknown/SXMU_2_PROCESSED/MDD/59chs",
                file,
            )
            for file in os.listdir(
                "/data/sxk/labram2_resting_fine_pool/resting_unknown/SXMU_2_PROCESSED/MDD/59chs"
