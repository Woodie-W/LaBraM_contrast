...
drop_channels = ['PHOTIC-REF', 'IBI', 'BURSTS', 'SUPPR', 'EEG ROC-REF', 'EEG LOC-REF', 'EEG EKG1-REF', 'EMG-REF',
                 'EEG C3P-REF', 'EEG C4P-REF', 'EEG SP1-REF', 'EEG SP2-REF', \
                 'EEG LUC-REF', 'EEG RLC-REF', 'EEG RESP1-REF', 'EEG RESP2-REF', 'EEG EKG-REF', 'RESP ABDOMEN-REF',
                 'ECG EKG-REF', 'PULSE RATE', 'EEG PG2-REF', 'EEG PG1-REF']
...
if __name__ == "__main__":
    ...
    # create the train, val, test.py sample folder
    ...
    if not os.path.exists(os.path.join(root, "processed", "test.py")):
        os.makedirs(os.path.join(root, "processed", "test.py"))
    test_dump_folder = os.path.join(root, "processed", "test.py")
