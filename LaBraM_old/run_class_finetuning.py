...
def get_dataset(args):
    ...
    # elif args.dataset == 'TUHEEG_PROCESSED':
    #     train_dataset, test_dataset, val_dataset,ch_names = utils.prepare_TUHEEG_PROCESSED_dataset('/data1/wangkuiyu/model_update_code/fine_pool/EEG/TUHEEG_PROCESSED')
    #     args.nb_classes = 2
    #     metrics = ["accuracy", "balanced_accuracy"]

    # elif args.dataset == 'SXMU_2_PROCESSED':
    #     train_dataset, test_dataset, val_dataset,ch_names = utils.prepare_SXMU_2_PROCESSED_dataset(root='/data1/wangkuiyu/model_update_code/fine_pool/EEG/SXMU_2_PROCESSED',args=args)
    #     args.nb_classes = 2
    #     metrics = ["accuracy", "balanced_accuracy"]
    
    # elif args.dataset == 'AD_FD_HC_PROCESSED':
    #     train_dataset, test_dataset, val_dataset,ch_names = utils.prepare_AD_FD_HC_PROCESSED_dataset(root='/data1/wangkuiyu/model_update_code/fine_pool/SFT/AD_FD_HC_PROCESSED',args=args)
    #     args.nb_classes = 3
    #     metrics = ["accuracy", "balanced_accuracy"]

    # # resting
    # elif args.dataset == 'resting_AD_FD_HC_PROCESSED':
    #     train_dataset, test_dataset, val_dataset,ch_names = utils.prepare_resting_AD_FD_HC_PROCESSED_dataset(root='/data1/wangkuiyu/model_update_code/resting_fine_pool/resting_eye_close/AD_FD_HC_PROCESSED',args=args)
    #     args.nb_classes = 3
    #     metrics = ["accuracy", "balanced_accuracy"]
    
    # elif args.dataset == 'resting_PREDICT-Depression_Rest':
    #     train_dataset, test_dataset, val_dataset,ch_names = utils.prepare_resting_PREDICT_Depression_Rest_dataset(root='/data1/wangkuiyu/model_update_code/resting_fine_pool/resting_unknown/PREDICT-Depression_Rest',args=args)
    #     args.nb_classes = 4
    #     metrics = ["accuracy", "balanced_accuracy"]
        
    # elif args.dataset == 'resting_Parkinson_eyes_open_PROCESSED':
    #     train_dataset, test_dataset, val_dataset,ch_names = utils.prepare_resting_Parkinson_eyes_open_PROCESSED_dataset(root='/data1/wangkuiyu/model_update_code/resting_fine_pool/resting_eye_open/Parkinson_eyes_open_PROCESSED',args=args)
    #     args.nb_classes = 2
    #     metrics = ["accuracy", "balanced_accuracy"]
        
    # elif args.dataset == 'resting_PREDICT_PD_LPC_Rest':
    #     train_dataset, test_dataset, val_dataset,ch_names = utils.prepare_resting_PREDICT_PD_LPC_Rest_dataset(root='/data1/wangkuiyu/model_update_code/resting_fine_pool/resting_unknown/PREDICT-PD_LPC_Rest',args=args)
    #     args.nb_classes = 2
    #     metrics = ["accuracy", "balanced_accuracy"]
    
    # elif args.dataset == 'resting_SXMU_2_PROCESSED':
    #     train_dataset, test_dataset, val_dataset,ch_names = utils.prepare_resting_SXMU_2_PROCESSED_dataset(root='/data1/wangkuiyu/model_update_code/resting_fine_pool/resting_unknown/SXMU_2_PROCESSED',args=args)
    #     args.nb_classes = 2
    #     metrics = ["accuracy", "balanced_accuracy"]
    
    elif args.dataset in ['Td_eyeopen','Td_eyeclose','Parkinson_eyes_open_PROCESSED','PREDICT-PD_LPC_Rest','PREDICT-PD_LPC_Rest_2','Parkinson']:
        train_dataset, test_dataset, val_dataset,ch_names = prepare_parkinson_dataset(val_dataset=None)
        args.nb_classes = 2
        metrics = ["accuracy", "balanced_accuracy"]
...
def get_dataset(args):
    ...
    dataset_train_list,train_ch_names_list = utils.build_finetuning_dataset(dataset_train, label2int={'HC': 0, 'HEALTHY': 0, 'LowOCD': 0,
                'PD': 1, 'PARKINSON': 1,})
    
    dataset_val = []
    
    dataset_val_list,val_ch_names_list = utils.build_finetuning_dataset(dataset_val, label2int={'HC': 0, 'HEALTHY': 0, 'LowOCD': 0,
                'PD': 1, 'PARKINSON': 1,})
    
    metrics = ["accuracy", "balanced_accuracy"]
    
    return dataset_train_list, train_ch_names_list, dataset_val_list, val_ch_names_list, metrics
